...
selectedButtons: string[] = []; 
  ...
  items = [
    { id: 1, title: 'Tulip Wadhwa Wise City', description: '1 BHK Apartment in Ulwe', bhkOptions: ['1 BHK', '2 BHK'], priceOptions: ['₹15 - 25 L', '₹25 - 30 L'], beds: 4, baths: 2, hasParking: true, image: 'cont-1.png', featured: true ,status:'Ready to move',amenities: ['Lift', 'Parking', 'Gymnasium','Security','Fire Safety','Swimming pool'], },
      ...
      { id: 4, title: 'The Highlands', description: '2 BHK Apartment in Ulwe', bhkOptions: ['1 BHK', '2 BHK'], priceOptions: ['₹16 - 26 L', '₹26 - 30 L'], beds: 4, baths: 2, hasParking: true, image: 'cont-5.png', featured: true,status:'Ready to move', amenities: ['Swimming Pool', 'Security', 'Clubhouse','Security','Lift','Fire Safety','Parking'] },
      ...
      { id: 6, title: 'Paradise', description: '2 BHK Apartment in Ulwe', bhkOptions: ['1 BHK', '2 BHK'], priceOptions: ['₹14 - 26 L', '₹26 - 40 L'], beds: 4, baths: 2, hasParking: true, image: 'cont-1.png', featured: true, newLaunch: true ,status:'New Launch', amenities: ['Swimming Pool', 'Security', 'Clubhouse','Security','Lift','Fire Safety','Parking']}
    ];
